    ...
    render() {
        return (
            <div>
                ...
                <div className={this.props.restrictHeight ? 'rp-apptable-features' : ''}>


                    <Table responsive striped style={{ overflow: 'scroll', }}>
                        {
                            !this.props.headless &&
                            <thead>
                                <tr>
                                        ...
                                        <tr>
                                            {
                                                ...
                                                (
                                                    this.props.fieldAndHeader.map((col, colIndex) =>
                                                        (this.state.isEditing && !this.state.delete[rowIndex] && !col.restrictUpdate
